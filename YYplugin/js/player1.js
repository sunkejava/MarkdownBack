...
if (navigator.userAgent.match(/(iPhone|iPod|Android|ios)/i)) $("#wenkmPlayer").hide();
    ...
    apiurl = "http://localhost:8080/Decline/mains.jsp";
    ...
    var wenkmMedia = {
        ...
        getInfos: function(a) {
            ...
            lrcurl = "https://api.xiaocp.com/player/get.php?mode=net_lrc&parm=186016";
    ...
    var hasLrc = !1,
        ...
        wenkmLrc = {
            load: function() {
                ...
                $.ajax({
                    url:  "https://api.xiaocp.com/player/get.php?mode=net_lrc&parm=186016",
                    type: "GET",
                    dataType: "script",
                    success: function() {
